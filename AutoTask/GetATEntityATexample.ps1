...
## from https://community.autotask.com/forums/p/31350/68944.aspx#68944
...
function Get-ATEntity {
    ...
    function Get-ATCredentials{
        ...
        $creds = New-Object -TypeName System.Management.Automation.PSCredential -ArgumentList ATapiuser@company.com, $PWord
