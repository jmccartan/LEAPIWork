# modified to cancel tickets to Ultratech - where 
# $contractQuery = New-ATWSQuery "Ticket" "Title" "Equals" "SQL Server Message" 
# set to a status of 18 (Cancelled) - figured this out by setting 1 ticket to cancelled 
# 9/4/17 

# from https://klemmestad.com/2014/08/01/how-to-connect-to-autotask-webapi-using-powershell/

#region Include external function New-ATWSQuery 
...
############GET TIME ENTRIES LAST 7 DAYS #####################
# from https://klemmestad.com/2015/08/27/create-a-ticket-in-autotask-using-powershell/#comments

# Yes, you can get time entries through the API. Using my query function it could be done something like this:

#$Date = (Get-Date).AddDays(-7)
#$QueryXML = New-AtwsQuery TimeEntry dateworked greaterthanorequals $Date
#$Result = $atws.query($QueryXML)
#This would give you all time entries entered by any user into the system the last 7 days.

$contractQuery = New-ATWSQuery "Ticket" "Title" "Equals" "SQL Server Message" 
$Result = $atws.query($contractQuery)
